...
- (void)onSocksProxyCallback:(int)fd {
    ...
    if (fd > 0) {
        ...
        error = [NSError errorWithDomain:@"com.goandfight.roar" code:100 userInfo:@{NSLocalizedDescriptionKey: @"Fail to start socks proxy"}];
    }
...
- (void)onShadowsocksCallback:(int)fd {
    ...
    if (fd > 0) {
        ...
        error = [NSError errorWithDomain:@"com.goandfight.roar" code:100 userInfo:@{NSLocalizedDescriptionKey: @"Fail to start http proxy"}];
    }
    if (self.shadowsocksCompletion) {
